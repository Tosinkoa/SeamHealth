...
const Table = ({ allUsers, formData }) => {
  ...
  return (
    <div className="overflow-hidden border shadow-xl dark:shadow-gray-600  sm:mx-4 md:mx-10 lg:mx-28 my-6 rounded-lg">
      <h1 className="font-bold text-xl m-3 sm:ml-7 lg:ml-12">Doctor List</h1>
      <TableFilter filter={globalFilter} setFilter={setGlobalFilter} />
      <div className=" w-11/12 object-contain mt-10 mx-auto shadow-md my-10">
